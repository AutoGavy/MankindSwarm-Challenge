...
function HarvesterDied()
{
	...
	self.DisconnectOutput("OnDeath", "HarvesterDied");
}
...
self.GetScriptScope().HarvesterDied <- HarvesterDied;
self.ConnectOutput("OnDeath", "HarvesterDied");
